...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('audio_campaigns', {
      id: {
    ...
    await queryInterface.addConstraint('audio_campaigns', {
      fields: ['department_id'],
      type: 'foreign key',
      name: 'fk_audio_campaigns_department_id_departments',
      references: {
        table: 'departments',
        field: 'id',
      },
    ...
    await queryInterface.addConstraint('audio_campaigns', {
      fields: ['created_by'],
      type: 'foreign key',
      name: 'fk_audio_campaigns_created_by_users',
      references: {
        table: 'users',
        field: 'id',
      },
    ...
    await queryInterface.addConstraint('audio_campaigns', {
      fields: ['updated_by'],
      type: 'foreign key',
      name: 'fk_audio_campaigns_updated_by_users',
      references: {
        table: 'users',
        field: 'id',
      },
    ...
    await queryInterface.addConstraint('audio_campaigns', {
      fields: ['deleted_by'],
      type: 'foreign key',
      name: 'fk_audio_campaigns_deleted_by_users',
      references: {
        table: 'users',
        field: 'id',
      },
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('audio_campaigns');
  },
};
