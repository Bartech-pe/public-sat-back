import { Channels, ChatStatus, MessageStatus } from '@common/interfaces/multi-channel-chat/channel-message/channel-chat-message.dto';
...
export class GetChannelSummaryDto {
  ...
  @IsString()
  @IsIn(['all', 'telegram', 'whatsapp', 'instagram', 'messenger', 'email', 'sms', 'chatsat'])
  channel: 'all' | 'telegram' | 'whatsapp' | 'instagram' | 'messenger' | 'email' | 'sms' | 'chatsat';
