...
import { VicidialCampaingRepository } from './repositories/vicidialCampaing.repository';
...
@Module({
  imports: [
    SequelizeModule.forFeature(
      [
        ...
        VicidialLists,
        VicidialLead,
        VicidialCallTimes,VicidialCallTimesHolidays
      ],
      'central',
    ),
    UserModule,
  ...
  controllers: [CentralTelefonicaController, AudioController, AloSatController,VicidialCallTimeController,VicidialCallTimeHolidayController],
  providers: [VicidialUserService, AudioService, AloSatService,VicidialCallTimesHolidaysService,VicidialCallTimesService,VicidialCampaingRepository],
