...
export class EmailCenterController {
  ...
  @Put('changeChatState/:userId/:channelStateId')
  async changeChatState(
    @Param('channelStateId') channelStateId: number,
    @Param('userId') userId: number,
  ) {
    return await this.mailCenterService.changeChatState(userId, channelStateId);
  }

  @Put('changeWspState/:userId/:channelStateId')
  async changeWspState(
    @Param('channelStateId') channelStateId: number,
    @Param('userId') userId: number,
  ) {
