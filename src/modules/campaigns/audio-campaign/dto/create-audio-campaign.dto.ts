...
export class CreateAudioCampaignDto {
  ...
  @IsString({ message: v.isString('vdAudioCampaignId') })
  @IsOptional()
  vdAudioCampaignId?: string;

  @ApiProperty({ description: 'nombre de la campaña' })
  @IsString({ message: v.isString('vdAudioCampaignName') })
  vdAudioCampaignName: string;
