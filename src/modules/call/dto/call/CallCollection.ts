...
export const StateCountItems: StateCountItem[] = [
  ...
  { name: 'Concluida', total:0, icon: 'mdi:check-circle', style: 'text-green-500' },
  { name: 'Abandonado', total: 0, icon: 'mdi:close-circle', style: 'text-red-500' },
  { name: 'Escalado', total: 0, icon: 'mdi:arrow-up', style: 'text-yellow-500' }
]
