...
export class MonitorController {
    ...
    async getStateDetailsByAdvisor(@Param('agent') agent: string,@Param('start') start: Date,@Param('finish') finish: Date){
        return await this.monitorVicidialService.getStateDetailsByAdvisor(agent,start,finish)
    }
